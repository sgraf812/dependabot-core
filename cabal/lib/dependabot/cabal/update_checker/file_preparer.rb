      ...
      class FilePreparer
        ...
        def temporary_requirement_for_resolution(filename)
          ...
          unless latest_allowable_version &&
                 Cabal::Version.correct?(latest_allowable_version) &&
                 Cabal::Version.new(latest_allowable_version) >=
                 Cabal::Version.new(lower_bound_version)
          ...
          @lower_bound_version ||=
            if git_dependency? && git_dependency_version
              ...
              version_from_requirement =
                ...
                compact.
                flat_map { |req_str| Cabal::Requirement.new(req_str) }.
        ...
        def manifest_files
          @manifest_files ||=
            dependency_files.select { |f| f.name.end_with?("cabal.project") }

          raise "No cabal.project!" if @manifest_files.none?
