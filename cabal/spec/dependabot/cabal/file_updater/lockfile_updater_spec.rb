...
require "dependabot/cabal/file_updater/lockfile_updater"

RSpec.describe Dependabot::Cabal::FileUpdater::LockfileUpdater do
  let(:updater) do
    described_class.new(
  ...
  describe "#updated_lockfile_content" do
    ...
    context "when updating the lockfile fails" do
      ...
      let(:requirements) do
        [{ file: "cabal.project", requirement: "99", groups: [], source: nil }]
      end
    ...
    describe "the updated lockfile" do
      ...
      context "with a blank requirement" do
        ...
        let(:previous_requirements) do
          [{ file: "cabal.project", requirement: nil, groups: [], source: nil }]
        end
