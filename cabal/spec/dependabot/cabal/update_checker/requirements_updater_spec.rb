...
require "spec_helper"
require "dependabot/cabal/update_checker/requirements_updater"

RSpec.describe Dependabot::Cabal::UpdateChecker::RequirementsUpdater do
  let(:updater) do
    described_class.new(
