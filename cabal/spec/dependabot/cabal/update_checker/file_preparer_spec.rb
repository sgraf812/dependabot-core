...
RSpec.describe Dependabot::Cabal::UpdateChecker::FilePreparer do
  let(:preparer) do
    described_class.new(
  ...
  describe "#prepared_dependency_files" do
    ...
    describe "the updated cabal.project" do
      subject(:prepared_manifest_file) do
        prepared_dependency_files.find { |f| f.name == "cabal.project" }
      end
